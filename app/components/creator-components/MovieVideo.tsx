...
import TeamSwitcher from "@/components/creator-dashboard/components/team-switcher";
import { MainNav } from "@/components/creator-dashboard/components/main-nav";
import { Search } from "@/components/creator-dashboard/components/search";
import { UserNav } from "@/components/creator-dashboard/components/user-nav";
...
export default async function MovieVideo() {
  ...
  return (
    <div className="h-[50vh] sm:h-[55vh] lg:h-[60vh] mt-[5%] sm:mt-[10%] mb-[5%] sm:mb-[10%] w-full flex flex-col md:flex-row justify-start items-center">
      <>
        {/* Image Section */}
